...
ESCRIPT = /data/data/com.termux/files/usr/lib/erlang/bin/escript
REBAR = /data/data/com.termux/files/usr/bin/mix # rebar|rebar3|mix binary (or path to binary)
REBAR3 =  # path to rebar3 binary
MIX = /data/data/com.termux/files/usr/bin/mix
AWK = gawk
